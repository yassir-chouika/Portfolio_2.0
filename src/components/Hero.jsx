  ...
  return (
    ...
    >
      <div className="text-sm text-center mt-24 px-5 laptop:text-left tablet:text-lg flex flex-col md:my-16 laptop:my-20 laptop:ml-6">
        ...
        <div className="flex justify-center mt-5 gap-3 laptop:justify-start">
          <button
            ...
            intersect:motion-translate-x-in-[1%] intersect:motion-translate-y-in-[200%] motion-opacity-in-[0%] motion-blur-in-[5px] motion-duration-[1000ms] motion-delay-[140ms] motion-delay-[0ms]/translate motion-delay-[0ms]/opacity motion-delay-[0ms]/blur intersect:motion-ease-spring-smooth hover:scale-105 duration-200"
          >
          ...
          <button
            ...
            type="button"
            className="text-white bg-SteelBlue hover:bg-IceBlue focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800
            intersect:motion-translate-x-in-[1%] intersect:motion-translate-y-in-[200%] motion-opacity-in-[0%] motion-blur-in-[5px] motion-duration-[1000ms] motion-delay-[150ms]/translate motion-delay-[0ms]/opacity motion-delay-[0ms]/blur intersect:motion-ease-spring-smooth hover:scale-105 duration-200"
          >
      ...
      <div className="w-full lgDesktop:w-4/5">
        <img
          className="w-full z-0 intersect-once intersect:motion-translate-x-in-[-110%] intersect:motion-translate-y-in-[0%] motion-opacity-in-[0%] motion-blur-in-[5px] motion-duration-[950ms] intersect:motion-ease-spring-smooth"
