...
const Hero = () => {
  return (
    <section className="flex flex-col md:flex-row laptop:flex-row laptop:justify-between bg-OffWhite">
      <div className="text-sm text-center mt-24 px-5 laptop:text-left tablet:text-lg flex flex-col md:my-16 laptop:my-20 laptop:ml-6">
        <p>HELLO THERE, WELCOME TO MY DIGITAL SPACE</p>
        <h1 className="text-5xl laptop:text-7xl font-extrabold font-space">
        ...
        <div className="flex justify-center mt-3 gap-3 laptop:justify-start">
          <button
            type="button"
      ...
      <div className="w-full">
        <img
          className="w-full"
          src="../public/Hero_illustration2.png"
          alt="logo"
        />
      </div>
    </section>
